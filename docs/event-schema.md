...
- `placement_id` (String)
- `reason` (String) — low-cardinality only: first_session / not_activated_session_2 / paid / consent / appopen_eligible / mutex / cooldown / not_ready / remote_config_off / global_off / not_eligible / entitlement_unknown / bg_too_short / suppress_zone / not_preloaded / protected_flow / onboarding_incomplete / already_shown_this_install / fullscreen_onboarding_ad_recently_shown / recent_onboarding_interstitial
